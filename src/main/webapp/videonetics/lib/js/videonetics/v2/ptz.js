 ...
 */
var ptzaction_v2p0 = function(actn,cam) {
...
//
	LiveStreamObject.camera.videonetics.ptz =urlcreator_v2p0(4)+"/"+LiveStreamObject.camera.id+"/"+actn+"/"+LiveStreamObject.camera.ptz;
					$.ajax({
						method: "GET",
						url: LiveStreamObject.camera.videonetics.ptz,
