...
function startalive_v1p8() {
  var playerobj = {};
  var ajaxip = {
    "loginid": LiveStreamObject.connect.server.stream.username,
    "pass": LiveStreamObject.connect.server.stream.password,
    "jsessionid": LiveStreamObject.camera.sid,
  ...
  var body = JSON.stringify({
    "url": "http://" + LiveStreamObject.connect.server.stream.ip + ":" + LiveStreamObject.connect.server.stream.port + "/" + LiveStreamObject.connect.server.stream.project,
    "body": ajaxip
  });
