...
function intialiseKeepLive_v2p2()
{
	console.log(new Date(),": intialiseKeepLive_v2p2");

	 LiveStreamObject.timer.object= setInterval(function(){
		 KeepLiveRequest_v2p2();
 }, 60000 * LiveStreamObject.timer.interval);

}

function KeepLiveRequest_v2p2()
{
	LiveStreamObject.camera.videonetics.keepLive = urlcreator_v2p2(2);
	console.log("keepalive.js  started after 4minutes--KeepLiveRequest_v2p2",LiveStreamObject.camera.videonetics.keepLive+"/"+LiveStreamObject.camera.videonetics.sessionId);
