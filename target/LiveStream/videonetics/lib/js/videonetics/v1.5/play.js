...
LiveStreamObject.camera.videonetics.loginUrl =urlcreator_v1p5(5);
	LiveStreamObject.camera.videonetics.startLive =urlcreator_v1p5(1);
...
//////////////////// TESTING
	if(LiveStreamObject.camera.id != null && LiveStreamObject.camera.id != 0 && LiveStreamObject.camera.id != undefined) login_v1p5();
	
//////////////////	
	//if(LiveStreamObject.camera.id != null && LiveStreamObject.camera.id != 0 && LiveStreamObject.camera.id != undefined) startalive_v1p5();


}

/*
function startLiveActions_v1p5()  // will call After  Start Alive  // Moved to onloader.js
{
	LiveStreamObject.camera.videonetics.keepLive =urlcreator_v1p5(2);
