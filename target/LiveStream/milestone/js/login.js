...
var login = function() {
	...
	var username = LiveStreamObject.connect.login.username;  // prompt('Username');
	var password = LiveStreamObject.connect.login.password; //prompt('Password');
	...
	sendCommandRequest(loginXMLMessage, success, 1);
